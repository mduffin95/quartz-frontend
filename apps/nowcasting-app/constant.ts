...
export const API_PREFIX = process.env.NEXT_PUBLIC_API_PREFIX || "https://api.quartz.solar/v0";
export const SITES_API_PREFIX =
  process.env.NEXT_PUBLIC_SITES_API_PREFIX || "https://api-site.quartz.solar";
